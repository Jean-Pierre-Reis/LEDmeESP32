...
// Include libraries for HUB75 matrix

#include <ESP32-HUB75-MatrixPanel-I2S-DMA.h>
#include <Ps3Controller.h>
#include <Tone32.h>

// Setup HUB75 matrix panel for ESP32
...
void setup() 
{
  ...
  dma_display->setBrightness8(128); //0-255 - default 90
...
// Joystick inquiry (allows to use a PS3 joystick)
boolean joy1Up(){
...
// Draw the Pi of the Pierre logo
void drawP(int x, int y)
{
  dma_display->fillRect(40, 9, 11, 1, dma_display->color565(0, 0, 255));
 
  dma_display->fillRect(39, 10, 12, 1, dma_display->color565(0, 0, 255));
 
  dma_display->fillRect(38, 11, 13, 1, dma_display->color565(0, 0, 255));
 
  dma_display->fillRect(37, 12, 2, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(41, 12, 2, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(46, 12, 3, 1, dma_display->color565(0, 0, 255));
 
  dma_display->fillRect(36, 13, 1, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(41, 13, 2, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(45, 13, 3, 1, dma_display->color565(0, 0, 255));

  dma_display->fillRect(41, 14, 2, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(45, 14, 3, 1, dma_display->color565(0, 0, 255));

  dma_display->fillRect(41, 15, 2, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(45, 15, 3, 1, dma_display->color565(0, 0, 255));

  dma_display->fillRect(40, 16, 3, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(45, 16, 3, 1, dma_display->color565(0, 0, 255));

  dma_display->fillRect(40, 17, 3, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(45, 17, 3, 1, dma_display->color565(0, 0, 255));

  dma_display->fillRect(39, 18, 4, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(45, 18, 3, 1, dma_display->color565(0, 0, 255));

  dma_display->fillRect(39, 19, 4, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(45, 19, 3, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(50, 19, 2, 1, dma_display->color565(0, 0, 255));

  dma_display->fillRect(38, 20, 5, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(45, 20, 6, 1, dma_display->color565(0, 0, 255));

  dma_display->fillRect(38, 21, 4, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(46, 21, 4, 1, dma_display->color565(0, 0, 255));
  
  dma_display->fillRect(39, 22, 2, 1, dma_display->color565(0, 0, 255));
  dma_display->fillRect(47, 22, 2, 1, dma_display->color565(0, 0, 255));
}

// Draw the R of the Pierre logo
void drawR(int x, int y)
{
  dma_display->fillRect(52, 9, 4, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(52, 10, 5, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(52, 11, 6, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(55, 12, 3, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(55, 13, 3, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(54, 14, 3, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(53, 15, 3, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(52, 16, 3, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(52, 17, 3, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(53, 18, 3, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(54, 19, 3, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(55, 20, 3, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(56, 21, 3, 1, dma_display->color565(255, 0, 0));
  dma_display->fillRect(57, 22, 3, 1, dma_display->color565(255, 0, 0));
}
...
{ 
  ...
  if(level == 2)
  {
    ...
    dma_display->fillRect(0, 28, 64, 4, dma_display->color565(0, 0, 109));
  }
  ...
  if(level == 3)
  {
    ...
    dma_display->fillRect(0, 24, 64, 8, dma_display->color565(0, 36, 0));
  }
  ...
  if(level == 4)
  {
    ...
    dma_display->fillRect(0, 24, 64, 8, dma_display->color565(36, 36, 0));
  }
  ...
  if(level == 5)
  {
    ...
    dma_display->fillRect(0, 0, 64, 4, dma_display->color565(0, 0, 36));
    dma_display->fillRect(0, 28, 64, 4, dma_display->color565(0, 0, 36));
  }
  ...
  if(level == 6)
  {
    ...
    dma_display->fillRect(0, 0, 64, 8, dma_display->color565(36, 0, 0));
    dma_display->fillRect(0, 24, 64, 8, dma_display->color565(36, 0, 0));
  }
...
void moveShip()
{
  // Initialize PS3 analog stick variables
    ...
    do
    {
      ...
      do
      {
        ...
        { 
          ...
          //dma_display->setCursor(27, 14);
          //dma_display->println("PAUSE");         
          tone(BUZZER_PIN,1024,20, BUZZER_CHANNEL);
          delay(500);
          do
          {
